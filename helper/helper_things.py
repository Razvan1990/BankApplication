...
class Helper:
    ...
    def check_for_leading_zeroes(self, number):
        modified_string_number = ""
        counter = 0
        ...
        if counter == 0:
            ...
            for i in range(0, counter):
                modified_string_number += "0"
            modified_string_number += str(number)
            return modified_string_number
    ...
    def calculate_conversion_currency(self, user_option, amount_transfered):
        if user_option==1:
            ...
            print("You have transferred ", round(result,2), end=" ");print(constants.NAMES_CURRENCY_ABREVIATED[0])
        if user_option == 2:
            result = amount_transfered / constants.DICTIONARY_CURRENCY[constants.NAMES_CURRENCY[1]]
            print("You have transferred ", round(result, 2), end=" ");print(constants.NAMES_CURRENCY_ABREVIATED[1])
        if user_option == 3:
            result = amount_transfered / constants.DICTIONARY_CURRENCY[constants.NAMES_CURRENCY[2]]
            print("You have transferred ", round(result, 2), end=" ");print(constants.NAMES_CURRENCY_ABREVIATED[2])
        if user_option == 4:
            result = amount_transfered / constants.DICTIONARY_CURRENCY[constants.NAMES_CURRENCY[3]]
            print("You have transferred ", round(result, 2), end=" ");print(constants.NAMES_CURRENCY_ABREVIATED[3])
